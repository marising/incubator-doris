...
public class PartitionCache extends Cache {
    ...
    public void copyRowBatch(RowBatch rowBatch) {
        if (rowBatchBuilder == null) {
            rowBatchBuilder = new RowBatchBuilder(CacheAnalyzer.CacheModel.Partition);
    ...
    public void updateCache() {
        ...
        LOG.info("update cache model {}, queryid {}, value count {}, row count {}, data size {}",
                CacheAnalyzer.CacheModel.Partition, queryId,
