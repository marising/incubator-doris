...
cp ${BROKER_HOME}/../../gensrc/thrift/JDOlapLoadService.thrift ${BROKER_HOME}/src/main/resources/thrift/

$MVN package -DskipTests

echo "Install broker..."
BROKER_OUTPUT=${BROKER_HOME}/output/jdolap_hive_broker/
rm -rf ${BROKER_OUTPUT}


echo "Clean thrift"
rm -rf ${DORIS_HOME}/src/main/resources/thrift
rm -rf ${DORIS_HOME}/src/main/thrift
...
cp -r -p ${BROKER_HOME}/target/jdolap_hive_broker.jar ${BROKER_OUTPUT}/lib/
